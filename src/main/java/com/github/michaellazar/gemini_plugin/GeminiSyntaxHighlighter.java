...
public class GeminiSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey @NotNull [] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(GeminiTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        }
        if (tokenType.equals(GeminiTypes.KEY)) {
            return KEY_KEYS;
        }
        if (tokenType.equals(GeminiTypes.VALUE)) {
            return VALUE_KEYS;
        }
        if (tokenType.equals(GeminiTypes.COMMENT)) {
            return COMMENT_KEYS;
        }
